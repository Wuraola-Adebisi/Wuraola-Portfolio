    ...
    <section className="min-h-screen flex items-center px-6 bg-neutral-50">
      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <p className="mt-6 max-w-2xl text-neutral-600 leading-relaxed">
          I build modern web interfaces with a focus on clarity, structure, and usability.
          My work is informed by a background in communication, marketing, and design.
        </p>
